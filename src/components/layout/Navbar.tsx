...
const Navbar = () => {
    ...
    return (
        <nav className="fixed w-full top-0 z-50 bg-white dark:bg-slate-950 border-b border-slate-100 dark:border-slate-800/50 shadow-sm transition-all duration-300">
